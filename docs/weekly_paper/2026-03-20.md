...
> 针对边缘设备MoE推理内存开销问题，提出动态混合精度量化框架，提升推理效率与精度平衡。

**Authors:** Yuegui Huang, Zhiyuan Fang, Weiqi Luo, Ruoyu Wu, Wuhui Chen, Zibin Zheng | **Date:** 2026-03-19

**Link:** [http://arxiv.org/abs/2603.19172v1](http://arxiv.org/abs/2603.19172v1)
...
> 针对LLM边缘-云协同推理成本与资源限制，提出流水线协作推测解码框架，优化带宽与计算平衡。

**Authors:** Yida Zhang, Zhiyong Gao, Shuaibing Yue, Jie Li, Rui Wang | **Date:** 2026-03-19

**Link:** [http://arxiv.org/abs/2603.19133v1](http://arxiv.org/abs/2603.19133v1)
...
![](https://img.shields.io/badge/speculative-F08080) ![](https://img.shields.io/badge/LLM-FF8C00) ![](https://img.shields.io/badge/serving-FF8C00) ![](https://img.shields.io/badge/inference-FF8C00)

> 针对LLM代理工具执行延迟瓶颈，提出模式感知推测工具执行方法，通过推测隐藏工具延迟。

**Authors:** Yifan Sui, Han Zhao, Rui Ma, Zhiyuan He, Hao Wang, Jianxun Li, Yuqing Yang | **Date:** 2026-03-19

**Link:** [http://arxiv.org/abs/2603.18897v1](http://arxiv.org/abs/2603.18897v1)
...
> 针对LLM后训练管道配置复杂度高问题，提出预算感知两阶段框架，自动优化配置选择。

**Authors:** Channe Chwa, Xinle Wu, Yao Lu | **Date:** 2026-03-19

**Link:** [http://arxiv.org/abs/2603.18773v1](http://arxiv.org/abs/2603.18773v1)
...
![](https://img.shields.io/badge/quantization-F08080) ![](https://img.shields.io/badge/acceleration-F08080) ![](https://img.shields.io/badge/transformer-FF8C00) ![](https://img.shields.io/badge/serving-FF8C00) ![](https://img.shields.io/badge/compression-FF8C00) ![](https://img.shields.io/badge/inference-FF8C00)

> 针对视频扩散模型推理内存与计算成本高问题，提出推理时混合精度量化方法，优化效率与质量权衡。

**Authors:** Rundong Su, Jintao Zhang, Zhihang Yuan, Haojie Duanmu, Jianfei Chen, Jun Zhu | **Date:** 2026-03-19

**Link:** [http://arxiv.org/abs/2603.18742v1](http://arxiv.org/abs/2603.18742v1)
...
![](https://img.shields.io/badge/sparse-F08080) ![](https://img.shields.io/badge/pruning-F08080) ![](https://img.shields.io/badge/sparsity-F08080) ![](https://img.shields.io/badge/attention-F08080) ![](https://img.shields.io/badge/inference-FF8C00)

> 针对视频生成稀疏注意力质量-加速权衡问题，提出离线分层稀疏分析与在线双向聚类方法，提升训练-free稀疏注意力效果。

**Authors:** Jiayi Luo, Jiayu Chen, Jiankun Wang, Cong Wang, Hanxin Zhu, Qingyun Sun, Chen Gao, Zhibo Chen, Jianxin Li | **Date:** 2026-03-19

**Link:** [http://arxiv.org/abs/2603.18636v1](http://arxiv.org/abs/2603.18636v1)
...
> 针对推测解码训练基础设施缺乏问题，提出灵活高效开源框架SpecForge，支持EAGLE-3训练与部署。

**Authors:** Shenggui Li, Chao Wang, Yikai Zhu, Yubo Wang, Fan Yin, Shuai Shi, Yefei Chen, Xiaomin Dong, Qiaoling Chen, Jin Pan, Ji Li, Laixin Xie, Yineng Zhang, Lei Yu, Yonggang Wen, Ivor Tsang, Tianwei Zhang | **Date:** 2026-03-19

**Link:** [http://arxiv.org/abs/2603.18567v1](http://arxiv.org/abs/2603.18567v1)
...
![](https://img.shields.io/badge/pruning-F08080) ![](https://img.shields.io/badge/serving-FF8C00) ![](https://img.shields.io/badge/language model-FF8C00)

> 针对MoE模型专家剪枝依赖校准集问题，提出校准-free任务无关剪枝方法，提升剪枝鲁棒性与泛化性。

**Authors:** Zongfang Liu, Shengkun Tang, Yifan Shen, Huan Wang, Xin Yuan | **Date:** 2026-03-19

**Link:** [http://arxiv.org/abs/2603.18492v1](http://arxiv.org/abs/2603.18492v1)
...
![](https://img.shields.io/badge/KV cache-F08080) ![](https://img.shields.io/badge/attention-F08080) ![](https://img.shields.io/badge/LLM-FF8C00) ![](https://img.shields.io/badge/LLMs-FF8C00) ![](https://img.shields.io/badge/inference-FF8C00) ![](https://img.shields.io/badge/language model-FF8C00)

> 针对扩散语言模型KV缓存决策开销高问题，提出熵引导KV缓存方法，以常数成本信号优化缓存更新。

**Authors:** Minsoo Cheong, Donghyun Son, Woosang Lim, Sungjoo Yoo | **Date:** 2026-03-19

**Link:** [http://arxiv.org/abs/2603.18489v1](http://arxiv.org/abs/2603.18489v1)
...
![](https://img.shields.io/badge/attention-F08080) ![](https://img.shields.io/badge/decoding-F08080) ![](https://img.shields.io/badge/serving-FF8C00) ![](https://img.shields.io/badge/inference-FF8C00) ![](https://img.shields.io/badge/language model-FF8C00)

> 针对长上下文推理注意力稀释问题，提出不确定性触发自适应上下文分配框架，动态调整缓存预算。

**Authors:** Lang Zhou, Shuxuan Li, Zhuohao Li, Shi Liu, Zhilin Zhao, Wei-Shi Zheng | **Date:** 2026-03-19

**Link:** [http://arxiv.org/abs/2603.18446v1](http://arxiv.org/abs/2603.18446v1)
...
![](https://img.shields.io/badge/overlap-F08080) ![](https://img.shields.io/badge/decoding-F08080) ![](https://img.shields.io/badge/LLM-FF8C00)

> 针对LLM解码策略静态且任务无关问题，提出基于强化学习的自适应解码器，通过策略学习优化生成质量。

**Authors:** Asmita Bhardwaj, Yuya Jeremy Ong, Eelaaf Zahid, Basel Shbita | **Date:** 2026-03-19

**Link:** [http://arxiv.org/abs/2603.18428v1](http://arxiv.org/abs/2603.18428v1)
...
![](https://img.shields.io/badge/pruning-F08080) ![](https://img.shields.io/badge/quantization-F08080) ![](https://img.shields.io/badge/pipeline-F08080) ![](https://img.shields.io/badge/compression-FF8C00)

> 针对联合模型压缩顺序影响未探索问题，分析剪枝与量化顺序对压缩效果的影响，指导压缩管道设计。

**Authors:** Minjun Kim, Jaehyeon Choi, Hyunwoo Yang, Jongjin Kim, Jinho Song, U Kang | **Date:** 2026-03-19

**Link:** [http://arxiv.org/abs/2603.18426v1](http://arxiv.org/abs/2603.18426v1)
...
![](https://img.shields.io/badge/sparse-F08080) ![](https://img.shields.io/badge/sparsity-F08080) ![](https://img.shields.io/badge/acceleration-F08080) ![](https://img.shields.io/badge/attention-F08080) ![](https://img.shields.io/badge/transformer-FF8C00)

> 针对稀疏注意力超参数手动调优问题，提出多保真度超参数优化框架，自动发现层与头特定最优参数。

**Authors:** Arundhathi Dev, Justin Zhan | **Date:** 2026-03-19

**Link:** [http://arxiv.org/abs/2603.18417v1](http://arxiv.org/abs/2603.18417v1)
...
![](https://img.shields.io/badge/prefill-F08080) ![](https://img.shields.io/badge/scheduling-F08080) ![](https://img.shields.io/badge/LLM-FF8C00) ![](https://img.shields.io/badge/LLMs-FF8C00) ![](https://img.shields.io/badge/serving-FF8C00) ![](https://img.shields.io/badge/inference-FF8C00)

> 针对LLM推理功耗建模缺乏问题，提出组合功耗轨迹生成方法，支持数据中心与电网基础设施规划。

**Authors:** Grant Wilkins, Fiodar Kazhamiaka, Ram Rajagopal | **Date:** 2026-03-19

**Link:** [http://arxiv.org/abs/2603.18383v1](http://arxiv.org/abs/2603.18383v1)
