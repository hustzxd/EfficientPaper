...
* [Decoding Uncertainty The Impact of Decoding Strategies for Uncertainty Estimation in Large Language Models](#decoding-uncertainty-the-impact-of-decoding-strategies-for-uncertainty-estimation-in-large-language-models)
...
* [Interplay Between Belief Propagation and Transformer Differential-Attention Message Passing Transformer](#interplay-between-belief-propagation-and-transformer-differential-attention-message-passing-transformer)
...
> [http://arxiv.org/abs/2509.17072v1](http://arxiv.org/abs/2509.17072v1)

The growing scale of large language models (![key](https://img.shields.io/badge/LLM-FF8C00)s) has intensified demands on
computation and memory, making efficient inference a key challenge. While
![key](https://img.shields.io/badge/sparsity-F08080) can reduce these costs, existing design space exploration (DSE)
frameworks often overlook ![key](https://img.shields.io/badge/compression-FF8C00) formats, a key factor for leveraging
![key](https://img.shields.io/badge/sparsity-F08080) on accelerators. This paper proposes SnipSnap, a joint ![key](https://img.shields.io/badge/compression-FF8C00)
format and dataflow co-optimization framework for efficient ![key](https://img.shields.io/badge/sparse-F08080) ![key](https://img.shields.io/badge/LLM-FF8C00)
accelerator design. SnipSnap introduces: (1) a hierarchical ![key](https://img.shields.io/badge/compression-FF8C00) format
encoding to expand the design space; (2) an adaptive ![key](https://img.shields.io/badge/compression-FF8C00) engine for
selecting formats under diverse ![key](https://img.shields.io/badge/sparsity-F08080); and (3) a progressive co-search
workflow that jointly optimizes dataflow and ![key](https://img.shields.io/badge/compression-FF8C00) formats. SnipSnap
...
> [http://arxiv.org/abs/2509.17030v1](http://arxiv.org/abs/2509.17030v1)

Recent studies have suggested a processing framework for multilingual inputs
in ![key](https://img.shields.io/badge/decode-F08080)r-based ![key](https://img.shields.io/badge/LLM-FF8C00)s: early layers convert inputs into English-centric and
...
multilingual ![key](https://img.shields.io/badge/LLM-FF8C00)s.
...
> [http://arxiv.org/abs/2509.16989v1](http://arxiv.org/abs/2509.16989v1)

Post-training ![key](https://img.shields.io/badge/quantization-F08080) (PTQ) of large language models (![key](https://img.shields.io/badge/LLM-FF8C00)s) to extremely
low bit-widths remains challenging due to the fundamental trade-off between
computational efficiency and model expressiveness. While existing ultra-![key](https://img.shields.io/badge/low-bit-F08080)
...
1-bit ![key](https://img.shields.io/badge/quantization-F08080), while maintaining superior expressiveness through its novel
...
model-agnostic deployment across diverse modern ![key](https://img.shields.io/badge/LLM-FF8C00)s without architectural
...
significantly outperforms existing ![key](https://img.shields.io/badge/low-bit-F08080) PTQ methods, achieving 82.4%
mathematical reasoning retention versus 0% for competing approaches. PTQTP
approaches and sometimes surpasses 1.58-bit ![key](https://img.shields.io/badge/quantization-F08080)-aware training
performance while requiring only single-hour ![key](https://img.shields.io/badge/quantization-F08080) compared to 10-14 GPU
days for training-based methods. These results establish PTQTP as a practical
solution for efficient ![key](https://img.shields.io/badge/LLM-FF8C00) deployment in resource-constrained environments.
...
> [http://arxiv.org/abs/2509.16970v1](http://arxiv.org/abs/2509.16970v1)
...
![key](https://img.shields.io/badge/LLM-FF8C00)-assisted semantic guidance framework tailored for ![key](https://img.shields.io/badge/sparse-F08080)ly annotated remote
sensing object detection, exploiting the advanced semantic reasoning
capabilities of large language models (![key](https://img.shields.io/badge/LLM-FF8C00)s) to distill high-confidence
pseudo-labels.By integrating ![key](https://img.shields.io/badge/LLM-FF8C00)-generated semantic priors, we propose a
Class-Aware Dense Pseudo-Label Assignment mechanism that adaptively assigns
pseudo-labels for both unlabeled and ![key](https://img.shields.io/badge/sparse-F08080)ly labeled data, ensuring robust
...
improving detection performance under ![key](https://img.shields.io/badge/sparse-F08080) annotations.
...
> [http://arxiv.org/abs/2509.16944v1](http://arxiv.org/abs/2509.16944v1)

Multimodal Large Language Models (M![key](https://img.shields.io/badge/LLM-FF8C00)s) require high-resolution visual
...
requiring either multi-pass ![key](https://img.shields.io/badge/prefill-F08080) stages or reliance on the slow
auto-regressive ![key](https://img.shields.io/badge/decoding-F08080) process. In this paper, we propose an efficient,
...
attention maps from the M![key](https://img.shields.io/badge/LLM-FF8C00)'s middle layers into high-quality pseudo-RoI
...
a single forward pass using features from the M![key](https://img.shields.io/badge/LLM-FF8C00)'s middle layers, decoupling
...
M![key](https://img.shields.io/badge/LLM-FF8C00)s without requiring costly supervision or full model fine-tuning. Code is
...
> [http://arxiv.org/abs/2509.16920v1](http://arxiv.org/abs/2509.16920v1)
...
Language Models (![key](https://img.shields.io/badge/LLM-FF8C00)s). SwarmChat enables users to issue natural language
commands to robotic swarms using multiple modalities, such as text, voice, or
teleoperation. The system integrates four ![key](https://img.shields.io/badge/LLM-FF8C00)-based modules: Context Generator,
...
commands based on real-time robot state, and suggest optimal ![key](https://img.shields.io/badge/communication-F08080)
...
SwarmChat's ![key](https://img.shields.io/badge/LLM-FF8C00) modules provide accurate context interpretation, relevant
...
> [http://arxiv.org/abs/2509.16857v1](http://arxiv.org/abs/2509.16857v1)

Distributed prefix caching accelerates long-context ![key](https://img.shields.io/badge/LLM-FF8C00) ![key](https://img.shields.io/badge/serving-FF8C00) by reusing ![key](https://img.shields.io/badge/KV-F08080)
![key](https://img.shields.io/badge/cache-F08080) entries for common context prefixes. However, ![key](https://img.shields.io/badge/KV-F08080) ![key](https://img.shields.io/badge/cache-F08080) fetches can become
a bottleneck when network bandwidth is limited. Compression mitigates the
bandwidth issue, but can degrade overall performance when de![key](https://img.shields.io/badge/compression-FF8C00)
interferes with model computation.
  We present ShadowServe, the first SmartNIC-accelerated, interference-free
prefix caching system for ![key](https://img.shields.io/badge/LLM-FF8C00) ![key](https://img.shields.io/badge/serving-FF8C00). ShadowServe separates a control plane on
...
> [http://arxiv.org/abs/2509.16853v1](http://arxiv.org/abs/2509.16853v1)

Prior studies in learned image ![key](https://img.shields.io/badge/compression-FF8C00) (LIC) consistently show that only
...
slice-parallel ![key](https://img.shields.io/badge/decoding-F08080), reduces redundancy, and improves bitrate efficiency.
...
![key](https://img.shields.io/badge/compression-FF8C00) frameworks.
...
> [http://arxiv.org/abs/2509.16794v1](http://arxiv.org/abs/2509.16794v1)
...
and illuminating metaphors to describe ![key](https://img.shields.io/badge/LLM-FF8C00)s has gained momentum. As an
...
feature of ![key](https://img.shields.io/badge/LLM-FF8C00)-based images and texts: their tendency to produce homogeneous
...
AI research, philosophy, and ![key](https://img.shields.io/badge/communication-F08080) studies in order to better
...
> [http://arxiv.org/abs/2509.16736v1](http://arxiv.org/abs/2509.16736v1)

Large Language Models (![key](https://img.shields.io/badge/LLM-FF8C00)s) have enabled the emergence of autonomous agents
...
decentralized environments where ![key](https://img.shields.io/badge/communication-F08080) lacks transparency and agent
...
> [http://arxiv.org/abs/2509.16696v1](http://arxiv.org/abs/2509.16696v1)
...
its uncertainty. In this study, we investigate the impact of ![key](https://img.shields.io/badge/decoding-F08080)
strategies on uncertainty estimation in Large Language Models (![key](https://img.shields.io/badge/LLM-FF8C00)s). Our
...
![key](https://img.shields.io/badge/LLM-FF8C00)s. In contrast, the benefits of these strategies sometimes diverge when the
...
> [http://arxiv.org/abs/2509.16686v1](http://arxiv.org/abs/2509.16686v1)

Reducing the key-value (![key](https://img.shields.io/badge/KV-F08080)) ![key](https://img.shields.io/badge/cache-F08080) size is a crucial step toward enabling
efficient inference in large language models (![key](https://img.shields.io/badge/LLM-FF8C00)s), especially under latency
...
Multi-head Latent Attention (MLA) mitigates this by compressing ![key](https://img.shields.io/badge/KV-F08080)
representations into a shared latent space, achieving a better trade-off
between performance and ![key](https://img.shields.io/badge/cache-F08080) efficiency. While MLA already achieves
significant ![key](https://img.shields.io/badge/KV-F08080) ![key](https://img.shields.io/badge/cache-F08080) reduction, the scope for further ![key](https://img.shields.io/badge/compression-FF8C00) remains
...
extension of MLA that further reduces ![key](https://img.shields.io/badge/KV-F08080) ![key](https://img.shields.io/badge/cache-F08080) size while enhancing
...
of compressed ![key](https://img.shields.io/badge/KV-F08080) vectors with minimal additional computation. Compared to MHA,
EG-MLA achieves over 91.6\% reduction in ![key](https://img.shields.io/badge/KV-F08080) ![key](https://img.shields.io/badge/cache-F08080) size with negligible
...
demonstrate robust generalization across model scales and ![key](https://img.shields.io/badge/compression-FF8C00) regimes.
Notably, we successfully scale EG-MLA to over 1 billion parameters,
demonstrating its practical viability for large-scale ![key](https://img.shields.io/badge/LLM-FF8C00) deployment. These
results establish EG-MLA as a memory- and compute-efficient attention mechanism
that enables scalable, high-performance inference in modern ![key](https://img.shields.io/badge/LLM-FF8C00)s.
...
> [http://arxiv.org/abs/2509.16664v1](http://arxiv.org/abs/2509.16664v1)
...
representations, there is significant interest in facilitating ![key](https://img.shields.io/badge/communication-F08080)
...
of previous models on downstream distributions while pre![key](https://img.shields.io/badge/serving-FF8C00) the newly
...
> [http://arxiv.org/abs/2509.16622v1](http://arxiv.org/abs/2509.16622v1)

Diffusion-based large language models (D![key](https://img.shields.io/badge/LLM-FF8C00)s) have recently attracted growing
interest as an alternative to autoregressive ![key](https://img.shields.io/badge/decode-F08080)rs. In this work, we present
...
as a standalone ![key](https://img.shields.io/badge/decode-F08080)r for ASR with diffusion-based and semi-autoregressive
![key](https://img.shields.io/badge/decoding-F08080). Most experimental configurations achieve faster inference than the
Whisper-LLaMA baseline, although recognition accuracy is slightly lower. These
findings offer an empirical view of diffusion-based ![key](https://img.shields.io/badge/LLM-FF8C00)s for ASR and point to
...
> [http://arxiv.org/abs/2509.16598v2](http://arxiv.org/abs/2509.16598v2)
...
contrastive ![key](https://img.shields.io/badge/decoding-F08080) method that constructs the amateur model via layer ![key](https://img.shields.io/badge/pruning-F08080)
rather than early exit. This design leads to more informative and well-aligned
logits, enabling more effective contrastive ![key](https://img.shields.io/badge/decoding-F08080). Through qualitative and
...
approach to mitigating hallucinations in ![key](https://img.shields.io/badge/LLM-FF8C00)s.
...
> [http://arxiv.org/abs/2509.16535v1](http://arxiv.org/abs/2509.16535v1)
...
![key](https://img.shields.io/badge/sparse-F08080) and interpretable equations for modal amplitudes that remained
...
achieving data ![key](https://img.shields.io/badge/compression-FF8C00) from three to five orders of magnitude depending on
dataset complexity.
...
> [http://arxiv.org/abs/2509.20375v1](http://arxiv.org/abs/2509.20375v1)

The rapid adoption of large language models (![key](https://img.shields.io/badge/LLM-FF8C00)s) such as ChatGPT has
...
to safeguard human authenticity and cultivate trust in digital ![key](https://img.shields.io/badge/communication-F08080).
...
classical Bag-of-Words, POS, and TF-IDF features) and ![key](https://img.shields.io/badge/transformer-FF8C00)-based (BERT
...
![key](https://img.shields.io/badge/transformer-FF8C00)-based representation over mere model diversity. By comprehensively
assessing the strengths and weaknesses of these AI-text detection approaches,
this work lays a foundation for more robust ![key](https://img.shields.io/badge/transformer-FF8C00) frameworks with larger,
...
> [http://arxiv.org/abs/2509.16518v1](http://arxiv.org/abs/2509.16518v1)

Generating realistic videos with diffusion ![key](https://img.shields.io/badge/transformer-FF8C00)s demands significant
computation, with attention layers the central bottleneck; even producing a
short clip requires running a ![key](https://img.shields.io/badge/transformer-FF8C00) over a very long sequence of
...
![key](https://img.shields.io/badge/sparsity-F08080) in the attention layers to reduce computation. However, these works
typically rely on block-![key](https://img.shields.io/badge/sparse-F08080) attention, which skips score computation only
...
attention scores does not fully exploit ![key](https://img.shields.io/badge/sparsity-F08080) in the attention map and
leaves room for improvement. In this work, we propose FG-Attn, a ![key](https://img.shields.io/badge/sparse-F08080)
attention mechanism for long-context diffusion ![key](https://img.shields.io/badge/transformer-FF8C00)s that leverages
![key](https://img.shields.io/badge/sparsity-F08080) at a fine granularity. Unlike block-![key](https://img.shields.io/badge/sparse-F08080) attention, which skips
...
![key](https://img.shields.io/badge/sparse-F08080) attention mechanism, we develop a new efficient bulk-load operation
called asynchronous-gather load. This load operation gathers a ![key](https://img.shields.io/badge/sparse-F08080) set of
relevant key-value vectors from memory and arranges them into packed tiles in
the GPU's shared memory. Only a ![key](https://img.shields.io/badge/sparse-F08080) set of keys relevant to those queries
are loaded into shared memory when computing attention for a block of queries,
in contrast to loading full blocks of key tokens in block-![key](https://img.shields.io/badge/sparse-F08080) attention. Our
fine-grained ![key](https://img.shields.io/badge/sparse-F08080) attention, applied to video diffusion models, achieves an
...
> [http://arxiv.org/abs/2509.16505v1](http://arxiv.org/abs/2509.16505v1)
...
non-terrestrial environments characterized by stringent ![key](https://img.shields.io/badge/communication-F08080) and
...
enhancing resilience and pre![key](https://img.shields.io/badge/serving-FF8C00) data locality. To validate our approach, we
...
> [http://arxiv.org/abs/2509.16502v1](http://arxiv.org/abs/2509.16502v1)

Retrieval-Augmented Generation (RAG) has significantly mitigated the
hallucinations of Large Language Models (![key](https://img.shields.io/badge/LLM-FF8C00)s) by grounding the generation with
...
reasoning needs of the ![key](https://img.shields.io/badge/LLM-FF8C00). They also struggle with scalability when performing
...
with ![key](https://img.shields.io/badge/LLM-FF8C00), which features an attention-based growing and ![key](https://img.shields.io/badge/pruning-F08080) mechanism,
...
infused into the ![key](https://img.shields.io/badge/LLM-FF8C00) together, thereby enhancing its reasoning capability and
facilitating interactive joint training of the graph retriever and the ![key](https://img.shields.io/badge/LLM-FF8C00)
...
strength of joint graph-![key](https://img.shields.io/badge/LLM-FF8C00) optimization for complex reasoning tasks. Notably,
our framework eliminates the need for predefined ground-truth entities by
directly optimizing the retriever using ![key](https://img.shields.io/badge/LLM-FF8C00) logits as implicit feedback, making
...
> [http://arxiv.org/abs/2509.16496v1](http://arxiv.org/abs/2509.16496v1)

The recent emergence of large language models (![key](https://img.shields.io/badge/LLM-FF8C00)s) such as GPT-3 has marked
...
intelligent systems process and interact with human language. Although ![key](https://img.shields.io/badge/LLM-FF8C00)s may
...
models that enable scalable, privacy-pre![key](https://img.shields.io/badge/serving-FF8C00) model training/fine-tuning
...
privacy-pre![key](https://img.shields.io/badge/serving-FF8C00) manner. In the latter, we investigate how the constraints
and structure of smart grids, spanning energy, ![key](https://img.shields.io/badge/communication-F08080), and regulatory
...
> [http://arxiv.org/abs/2509.16495v1](http://arxiv.org/abs/2509.16495v1)

Efficient parallelism is necessary for achieving low-latency, high-throughput
inference with large language models (![key](https://img.shields.io/badge/LLM-FF8C00)s). Tensor parallelism (TP) is the
state-of-the-art method for reducing ![key](https://img.shields.io/badge/LLM-FF8C00) response latency, however GPU
![key](https://img.shields.io/badge/communication-F08080)s reduces combined token throughput. On the other hand, data
...
because of the ![key](https://img.shields.io/badge/KV-F08080) ![key](https://img.shields.io/badge/cache-F08080) variance across the parallelisms.
  We notice Sequence Parallelism (SP - Ulysses in training) has similar
properties as DP but with ![key](https://img.shields.io/badge/KV-F08080) ![key](https://img.shields.io/badge/cache-F08080) invariance. We adapt SP to inference, and
...
GPU ![key](https://img.shields.io/badge/communication-F08080)s of Shift Parallelism yields up to i) 1.51x faster response
...
> [http://arxiv.org/abs/2509.16443v1](http://arxiv.org/abs/2509.16443v1)

The growing demand for low-latency, energy-efficient inference in large
language models (![key](https://img.shields.io/badge/LLM-FF8C00)s) has catalyzed interest in heterogeneous architectures.
...
We present LightCode, a compiler framework and simulator for mapping ![key](https://img.shields.io/badge/LLM-FF8C00)
...
the ![key](https://img.shields.io/badge/prefill-F08080) stage of GPT-2 and Llama-7B showing that under our workload and
...
for compiling ![key](https://img.shields.io/badge/LLM-FF8C00)s to emerging photonic accelerators.
...
> [http://arxiv.org/abs/2509.16437v1](http://arxiv.org/abs/2509.16437v1)

Empathy is increasingly recognized as a key factor in human-AI ![key](https://img.shields.io/badge/communication-F08080),
...
conversations between information workers and Large Language Models (![key](https://img.shields.io/badge/LLM-FF8C00)s),
...
showing that an ![key](https://img.shields.io/badge/LLM-FF8C00)-based classifier can recognize 5 levels of empathy with an
...
> [http://arxiv.org/abs/2509.16360v1](http://arxiv.org/abs/2509.16360v1)

Large Language Models (![key](https://img.shields.io/badge/LLM-FF8C00)s) hold promise in addressing complex medical
...
healthcare agents lies in the readability of ![key](https://img.shields.io/badge/LLM-FF8C00)-generated responses,
...
benchmark for evaluating the readability of ![key](https://img.shields.io/badge/LLM-FF8C00)s in public health question
...
score. Evaluation of 25 ![key](https://img.shields.io/badge/LLM-FF8C00)s reveals that most fail to meet readability
standards, highlighting a gap between reasoning and effective ![key](https://img.shields.io/badge/communication-F08080). To
...
> [http://arxiv.org/abs/2509.16354v1](http://arxiv.org/abs/2509.16354v1)
...
lack of natural structure, and limited label-pre![key](https://img.shields.io/badge/serving-FF8C00) augmentations. As a
result, ensemble models based on decision trees continue to dominate benchmark
leaderboards. In this work, we introduce RuleNet, a ![key](https://img.shields.io/badge/transformer-FF8C00)-based
architecture specifically designed for deep tabular learning. RuleNet
incorporates learnable rule embeddings in a ![key](https://img.shields.io/badge/decode-F08080)r, a piecewise linear
...
> [http://arxiv.org/abs/2509.16328v2](http://arxiv.org/abs/2509.16328v2)

Large-language models (![key](https://img.shields.io/badge/LLM-FF8C00)s) are rapidly being applied to radiology, enabling
...
run large ![key](https://img.shields.io/badge/LLM-FF8C00)s on imaging data. We review modern GPU architectures (e.g. NVIDIA
...
intensive and benefits from GPU parallelism and tensor-core ![key](https://img.shields.io/badge/acceleration-F08080).
...
mixed-precision, ![key](https://img.shields.io/badge/quantization-F08080), ![key](https://img.shields.io/badge/compression-FF8C00), and multi-GPU scaling. Finally, we
...
Advancing GPU infrastructure is essential for safe, efficient ![key](https://img.shields.io/badge/LLM-FF8C00)-based
...
> [http://arxiv.org/abs/2509.16197v1](http://arxiv.org/abs/2509.16197v1)

Unified multimodal Large Language Models (![key](https://img.shields.io/badge/LLM-FF8C00)s) that can both understand and
...
autoregressive ![key](https://img.shields.io/badge/LLM-FF8C00) predicts high-level semantics in the form of text and image
tokens, with an auxiliary diffusion ![key](https://img.shields.io/badge/decode-F08080)r subsequently translating the image
...
> [http://arxiv.org/abs/2509.16176v1](http://arxiv.org/abs/2509.16176v1)
...
natural language ![key](https://img.shields.io/badge/communication-F08080) between human directors and drones. The main
...
propose employing large language models (![key](https://img.shields.io/badge/LLM-FF8C00)s) and vision foundation models
...
> [http://arxiv.org/abs/2509.16107v1](http://arxiv.org/abs/2509.16107v1)
...
we systematically investigate whether Large Language Models (![key](https://img.shields.io/badge/LLM-FF8C00)s) can leverage
...
Llama-3.1-8B via ![key](https://img.shields.io/badge/LLM-FF8C00)-as-Judge and human annotations. Our findings indicate that
current ![key](https://img.shields.io/badge/LLM-FF8C00)s struggle to resolve ambiguity effectively: they tend to commit to
...
improve ![key](https://img.shields.io/badge/LLM-FF8C00)s' handling of ambiguity and to ensure robust performance across
diverse ![key](https://img.shields.io/badge/communication-F08080) styles.
...
> [http://arxiv.org/abs/2509.16101v1](http://arxiv.org/abs/2509.16101v1)
...
tensor factors with privacy-pre![key](https://img.shields.io/badge/serving-FF8C00) personalization mechanisms. The local
...
and factor matrices) across clients through differential privacy-pre![key](https://img.shields.io/badge/serving-FF8C00)
protocols. This tensorized approach enables efficient handling of
high-dimensional multi-view data with significant ![key](https://img.shields.io/badge/communication-F08080) savings through
...
> [http://arxiv.org/abs/2509.16098v1](http://arxiv.org/abs/2509.16098v1)

In this paper, we present SegDINO3D, a novel Transformer encoder-![key](https://img.shields.io/badge/decode-F08080)r
...
3D context fusion. In the ![key](https://img.shields.io/badge/decode-F08080)r stage, it formulates 3D object queries as 3D
...
while faithfully pre![key](https://img.shields.io/badge/serving-FF8C00) the knowledge of the pre-trained 2D model. The
...
> [http://arxiv.org/abs/2509.16028v1](http://arxiv.org/abs/2509.16028v1)

Spoken dialogue systems increasingly employ large language models (![key](https://img.shields.io/badge/LLM-FF8C00)s) to
leverage their advanced reasoning capabilities. However, direct application of
![key](https://img.shields.io/badge/LLM-FF8C00)s in spoken ![key](https://img.shields.io/badge/communication-F08080) often yield suboptimal results due to mismatches
between optimal textual and verbal delivery. While existing approaches adapt
![key](https://img.shields.io/badge/LLM-FF8C00)s to produce speech-friendly outputs, their impact on reasoning performance
...
reasoning capacity of ![key](https://img.shields.io/badge/LLM-FF8C00)s. Central to our method is verbalizing, an
...
> [http://arxiv.org/abs/2509.15974v1](http://arxiv.org/abs/2509.15974v1)
...
(![key](https://img.shields.io/badge/LLM-FF8C00)s) spanning encoder-only and ![key](https://img.shields.io/badge/decode-F08080)r-only architectures from 110M to 6.7B
...
> [http://arxiv.org/abs/2509.15940v1](http://arxiv.org/abs/2509.15940v1)

The scaling law for large language models (![key](https://img.shields.io/badge/LLM-FF8C00)s) depicts that the path
...
that span over thousands of computing nodes. However, ![key](https://img.shields.io/badge/LLM-FF8C00) pre-training presents
unique challenges due to its complex ![key](https://img.shields.io/badge/communication-F08080) patterns, where GPUs
exchange data in ![key](https://img.shields.io/badge/sparse-F08080) yet high-volume bursts within specific groups.
...
system summarizing our experience to effectively align ![key](https://img.shields.io/badge/LLM-FF8C00) ![key](https://img.shields.io/badge/communication-F08080)
patterns with data center topology at scale. An in-depth characteristic study
is performed to identify the impact of physical network topology to ![key](https://img.shields.io/badge/LLM-FF8C00)
pre-training jobs. Based on the insights, we develop a scheduling algorithm to
effectively align ![key](https://img.shields.io/badge/communication-F08080) patterns with the physical network topology in
modern data centers. Through simulation experiments, we show the effectiveness
of our algorithm in reducing the maximum spread of ![key](https://img.shields.io/badge/communication-F08080) groups by up
...
> [http://arxiv.org/abs/2509.15844v1](http://arxiv.org/abs/2509.15844v1)
...
Fuzzy Clustering (FedHK-MVFC) for secure, privacy-pre![key](https://img.shields.io/badge/serving-FF8C00) learning across
...
![key](https://img.shields.io/badge/communication-F08080), and $98.2 \%$ efficiency retention over centralized methods.
...
adaptive view weighting, and privacy-pre![key](https://img.shields.io/badge/serving-FF8C00) protocols. This presents a new
...
> [http://arxiv.org/abs/2509.15763v1](http://arxiv.org/abs/2509.15763v1)

Large language models are increasingly capable of handling long-context
inputs, but the memory overhead of key-value (![key](https://img.shields.io/badge/KV-F08080)) ![key](https://img.shields.io/badge/cache-F08080) remains a major
bottleneck for general-purpose deployment. While various ![key](https://img.shields.io/badge/compression-FF8C00) strategies
have been explored, sequence-level ![key](https://img.shields.io/badge/compression-FF8C00), which drops the full ![key](https://img.shields.io/badge/KV-F08080) ![key](https://img.shields.io/badge/cache-F08080)s
...
sequence-level long-context ![key](https://img.shields.io/badge/compression-FF8C00) framework that efficiently preserves
context information by replacing raw tokens with special ![key](https://img.shields.io/badge/compression-FF8C00) tokens
...
significantly improves ![key](https://img.shields.io/badge/compression-FF8C00) quality, with especially strong performance
...
> [http://arxiv.org/abs/2509.15724v1](http://arxiv.org/abs/2509.15724v1)
...
demands. We present RMT-KD, a ![key](https://img.shields.io/badge/compression-FF8C00) method that leverages Random Matrix
Theory (RMT) for knowledge distillation to iteratively reduce network size.
Instead of ![key](https://img.shields.io/badge/pruning-F08080) or heuristic rank selection, RMT-KD preserves only
...
> [http://arxiv.org/abs/2509.15667v1](http://arxiv.org/abs/2509.15667v1)

We present a multimodal fusion framework that bridges pre-trained
![key](https://img.shields.io/badge/decode-F08080)r-based large language models (![key](https://img.shields.io/badge/LLM-FF8C00)) and acoustic encoder-![key](https://img.shields.io/badge/decode-F08080)r
architectures such as Whisper, with the aim of building speech-enabled ![key](https://img.shields.io/badge/LLM-FF8C00)s.
...
Whisper's hidden ![key](https://img.shields.io/badge/decode-F08080)r states with those of an ![key](https://img.shields.io/badge/LLM-FF8C00) through cross-modal
attention, and supports both offline and streaming modes. We introduce
\textit{VoxKrikri}, the first Greek speech ![key](https://img.shields.io/badge/LLM-FF8C00), and show through analysis that
...
and low-resource speech ![key](https://img.shields.io/badge/LLM-FF8C00)s, while achieving state-of-the-art results for
...
> [http://arxiv.org/abs/2509.15640v1](http://arxiv.org/abs/2509.15640v1)

Medical English-Vietnamese machine translation (En-Vi MT) is essential for
healthcare access and ![key](https://img.shields.io/badge/communication-F08080) in Vietnam, yet Vietnamese remains a
low-resource and under-studied language. We systematically evaluate prompting
strategies for six multilingual ![key](https://img.shields.io/badge/LLM-FF8C00)s (0.5B-9B parameters) on the MedEV dataset,
...
primary driver of performance: larger ![key](https://img.shields.io/badge/LLM-FF8C00)s achieve strong zero-shot results,
...
and the current limitations of multilingual ![key](https://img.shields.io/badge/LLM-FF8C00)s for medical En-Vi MT.
...
> [http://arxiv.org/abs/2509.15637v1](http://arxiv.org/abs/2509.15637v1)

Transformer-based neural ![key](https://img.shields.io/badge/decode-F08080)rs have emerged as a promising approach to
error correction coding, combining data-driven adaptability with efficient
modeling of long-range dependencies. This paper presents a novel ![key](https://img.shields.io/badge/decode-F08080)r
architecture that integrates classical belief propagation principles with
![key](https://img.shields.io/badge/transformer-FF8C00) designs. We introduce a differentiable syndrome loss function
...
demonstrate consistent performance improvements over existing ![key](https://img.shields.io/badge/transformer-FF8C00)-based
![key](https://img.shields.io/badge/decode-F08080)rs, with our approach surpassing traditional belief propagation ![key](https://img.shields.io/badge/decode-F08080)rs
...
> [http://arxiv.org/abs/2509.15631v1](http://arxiv.org/abs/2509.15631v1)

As large language models (![key](https://img.shields.io/badge/LLM-FF8C00)s) are increasingly deployed across various
applications, privacy and copyright concerns have heightened the need for more
effective ![key](https://img.shields.io/badge/LLM-FF8C00) unlearning techniques. Many existing unlearning methods aim to
...
> [http://arxiv.org/abs/2509.19368v1](http://arxiv.org/abs/2509.19368v1)

Large language models (![key](https://img.shields.io/badge/LLM-FF8C00)s) deliver impressive generation quality, but incur
...
![key](https://img.shields.io/badge/decoding-F08080) (EESD) has emerged to mitigate this cost. However, in practice, many
approaches struggle to achieve the expected ![key](https://img.shields.io/badge/acceleration-F08080) in such
...
vast majority of draft tokens are accepted by the ![key](https://img.shields.io/badge/LLM-FF8C00). Otherwise, the draft
cost may overcome the ![key](https://img.shields.io/badge/acceleration-F08080) gain and lead to a negative speedup. To
...
remaining-layer (verification) computations ![key](https://img.shields.io/badge/overlap-F08080). We interleave drafting and
verification per token. While the ![key](https://img.shields.io/badge/LLM-FF8C00) is verifying the current token in its
...
results confirm that PPSD achieves state-of-the-art ![key](https://img.shields.io/badge/acceleration-F08080) in
self-speculative ![key](https://img.shields.io/badge/LLM-FF8C00) inference. On diverse benchmarks, PPSD achieves speedup
ratios in the range of 2.01x~3.81x, which gains almost the optimal ![key](https://img.shields.io/badge/acceleration-F08080)
...
> [http://arxiv.org/abs/2509.15550v1](http://arxiv.org/abs/2509.15550v1)

The rapid advancement of large language models (![key](https://img.shields.io/badge/LLM-FF8C00)s) has blurred the line
...
in significant ![key](https://img.shields.io/badge/overlap-F08080) between the feature distributions of human-written and
...
AI-generated text. Building on this perspective, we introduce DNA-Detect![key](https://img.shields.io/badge/LLM-FF8C00), a
...
Specifically, DNA-Detect![key](https://img.shields.io/badge/LLM-FF8C00) achieves relative improvements of 5.55% in AUROC
...
> [http://arxiv.org/abs/2509.15529v1](http://arxiv.org/abs/2509.15529v1)
...
areas of better query plans, ![key](https://img.shields.io/badge/cache-F08080)d execution plans, parallel processing, and
...
computation and ![key](https://img.shields.io/badge/serving-FF8C00). This study contributes to the understanding and design
...
> [http://arxiv.org/abs/2509.15515v1](http://arxiv.org/abs/2509.15515v1)

This paper revisits the ![key](https://img.shields.io/badge/LLM-FF8C00) ![key](https://img.shields.io/badge/cache-F08080) bandit problem, with a special focus on
addressing the query heterogeneity for cost-effective ![key](https://img.shields.io/badge/LLM-FF8C00) inference. Previous
works often assume uniform query sizes. Heterogeneous query sizes introduce a
combinatorial structure for ![key](https://img.shields.io/badge/cache-F08080) selection, making the ![key](https://img.shields.io/badge/cache-F08080) replacement
process more computationally and statistically challenging. We treat optimal
![key](https://img.shields.io/badge/cache-F08080) selection as a knapsack problem and employ an accumulation-based strategy
to effectively balance computational overhead and ![key](https://img.shields.io/badge/cache-F08080) updates. In theoretical
...
![key](https://img.shields.io/badge/cache-F08080) size. Additionally, we also provide a problem-dependent bound, which was
...
> [http://arxiv.org/abs/2509.15462v1](http://arxiv.org/abs/2509.15462v1)

While existing speech audio codecs designed for ![key](https://img.shields.io/badge/compression-FF8C00) exploit limited
...
leverage such representations in a novel semantic ![key](https://img.shields.io/badge/communication-F08080)s approach to
...
> [http://arxiv.org/abs/2509.15459v1](http://arxiv.org/abs/2509.15459v1)
...
design, we develop a dual-query ![key](https://img.shields.io/badge/transformer-FF8C00) ![key](https://img.shields.io/badge/decode-F08080)r that integrates perturbed
...
> [http://arxiv.org/abs/2509.15455v1](http://arxiv.org/abs/2509.15455v1)

Large Language Models (![key](https://img.shields.io/badge/LLM-FF8C00)s) promise impressive capabilities, yet their
multi-billion-parameter scale makes on-device or low-resource deployment
prohibitive. Mixed-precision ![key](https://img.shields.io/badge/quantization-F08080) offers a compelling solution, but
...
mixed-precision ![key](https://img.shields.io/badge/quantization-F08080) problem as a cooperative game among layers and
...
> [http://arxiv.org/abs/2509.19365v1](http://arxiv.org/abs/2509.19365v1)

The BERTopic framework leverages ![key](https://img.shields.io/badge/transformer-FF8C00) embeddings and hierarchical
...
and ![key](https://img.shields.io/badge/sparse-F08080), resulting in an excessive number of ![key](https://img.shields.io/badge/overlap-F08080)ping topics. Recent work
...
> [http://arxiv.org/abs/2509.16277v1](http://arxiv.org/abs/2509.16277v1)
...
![key](https://img.shields.io/badge/communication-F08080) chains that incrementally compress raw sensory inputs into
...
encourages entropy decay (D2), thus ensuring stable ![key](https://img.shields.io/badge/compression-FF8C00). Guided by
...
to two orders of magnitude. This stable information-![key](https://img.shields.io/badge/compression-FF8C00) perspective not
